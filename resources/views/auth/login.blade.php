          ...
          <div class="card card-login card-plain">
              ...
              <div class="card-body">
                ...
                <div class="input-group no-border input-lg">
                  ...
                  <input type="email" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="Digite seu e-mail" name="email" id="email" value="{{ old('email') }}" required autofocus>
                ...
                <div class="input-group no-border input-lg">
                  ...
                  <input type="password" name="password" id="password" placeholder="Digite sua senha" class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }}" required name="password" />
